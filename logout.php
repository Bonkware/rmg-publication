	  ...
	  <TABLE width="633" border="0" cellspacing="0" cellpadding="0">
	   <TR>
	     ...
	     <TABLE border="0" cellpadding="0" cellspacing="0" width="620">
	      <TR>
               <TD width="100%" align="LEFT" BGCOLOR="#31639C"><IMG SRC="images/blue_left.gif" WIDTH="5" HEIGHT="16" ALIGN="top"><FONT face="Arial" size="-1" color="#FFFFFF"><B>&nbsp;Thank you for using icraf_docman</FONT></B></TD>
